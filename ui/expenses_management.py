...
class ExpensesFrame(tk.Frame):
    def __init__(self, parent, dbmanager):
        ...
        # self.by_supplier_radiobutton = tk.Radiobutton(custom_search, text="Date", fg="white", bg="#3498db",
        ...
        # self.by_purchase_date_radiobutton = tk.Radiobutton(custom_search, text="Amount(More than)", fg="white", bg="#3498db",
        #                                                    activeforeground="white", width=12, font=("Segoe UI", 10),
        #                                                    activebackground="#1abc9c", selectcolor="#1abc9c",
        #                                                    variable=self.search_filter,
        #                                                    value="by_amount_more_than", command=self.search_by_amount_more_than)
        # self.by_delivery_date_radiobutton = tk.Radiobutton(custom_search, text="Amount(Less than)", fg="white", bg="#3498db",
        #                                                    activeforeground="white", width=12, font=("Segoe UI", 10),
        #                                                    activebackground="#1abc9c", selectcolor="#1abc9c",
        #                                                    variable=self.search_filter,
        #                                                    value="by_amount_less_than", command=self.search_by_amount_less_than, indicatoron=False)
        ...
        #
        # self.amount_entry = tk.Entry(custom_search, width=20, font=("Segoe UI", 10), )
        # self.amount_entry.grid(row=2, column=1, columnspan=2, pady=(0, 10), sticky=tk.EW)
    ...
    #     pass
    #
    # def search_by_amount_more_than(self):
    #     pass
    #
    # def search_by_amount_less_than(self):
    #     pass
    #
    ...
    def insert_expenses_to_treeview(self, expenses):
        ...
        for i, expense in enumerate(expenses):
            ...
            self.expenses_treeview.insert(
                ...
                values=(expense.date.strftime("%d-%m-%Y"), expense.time.strftime("%I:%M %p"), expense.purpose, expense.amount), tags=tag)